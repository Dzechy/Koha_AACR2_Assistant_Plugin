...
sub intranet_js {
    ...
    return try {
        ...
        my @js_files = (
            ...
            'js/cuttersanborn_data_part1.js',
            'js/cuttersanborn_data_part2.js',
            'js/cuttersanborn_data_part3.js',
            'js/cuttersanborn_data_part4.js',
            'js/cuttersanborn_data_part5.js',
            'js/cuttersanborn_data_part6.js',
            'js/cuttersanborn_data_part7.js',
            'js/cuttersanborn_data_part8.js',
            'js/cuttersanborn_data_part9.js',
            'js/cuttersanborn_data_part10.js',
            'js/cuttersanborn_data_part11.js',
            'js/cuttersanborn_data_part12.js',
            'js/cuttersanborn_data_part13.js',
