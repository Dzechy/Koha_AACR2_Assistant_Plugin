...
sub ai_models {
    return Koha::Plugin::Cataloging::AutoPunctuation::Api::ai_models(@_);
}

sub guide_progress_update {
    return Koha::Plugin::Cataloging::AutoPunctuation::GuideProgress::guide_progress_update(@_);
}

sub guide_progress_list {
    return Koha::Plugin::Cataloging::AutoPunctuation::GuideProgress::guide_progress_list(@_);
}
